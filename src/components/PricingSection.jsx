...
const PricingSection = () => {
  ...
  //caculate product price base on product count
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <h3 className="text-xl text-gray-600 mb-4">Starter Plan</h3>
            <p className="text-3xl font-bold mb-6">${starterPrice}/mo</p>
          </div>

          {/* business plan */}
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <h3 className="text-xl text-gray-600 mb-4">Business Plan</h3>
